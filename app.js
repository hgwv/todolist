...
function updateTodoList(){
    ...
    allTodoos.forEach((todo, todoIndex)=>{
...
function createTodoItem(todo, todoIndex){
    ...
    checkbox.addEventListener("change", ()=>{
        allTodoos[todoIndex].completed = checkbox.checked;
        saveTodos();
    })
...
function deleteTodoItem(todoIndex){
    allTodoos = allTodoos.filter((_, i)=> i !== todoIndex);
    saveTodos();
    updateTodoList();
}
function saveTodos(){
    const todosJson = JSON.stringify(allTodoos);
